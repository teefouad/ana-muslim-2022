...
const Root = styled('div', {
  ...
  const clockWidthInEm = getDigitsSizeInEm(hours!) + getDigitsSizeInEm(minutes!) + 0.2 + (mode === '12' ? periodSize! * 0.45 + 0.25 * 0.357 : 0); // 0.2 = colon width, 0.45 = period width(45px / 100px), 0.25 = period left margin in em
  ...
  return css`
    ...
    .wb-clock__period {
      ...
      transform: translateX(${getDigitsSizeInEm(minutes!, 100) / 0.357}em) scale(${periodSize}); /* divide by 0.357 to undo time period font size reduction */
